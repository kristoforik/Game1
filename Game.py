...
class Challenge2_1:
    ...
    def fail(self):
        print("Unfortunatelly, while entering the building you got injured and your ability was reduced by 1. However, due to your experience, you have the second chance to continue the mission. Type [1] to roll again")
    def full_success(self):
...
class Challenge3_1:
    ...
    def succes(self):
        print("YOU WON! Terrorists are dead and hostage is saved. Mission is done successfully.")
    def fail(self):
...
class Challenge1_2:
    ...
    def success(self):
        print("Well done! You hacked electricity and now terrorists don't have light.")
    def fail(self):
        print("Unfortunatelly, you didn't manage to hack the system this time and your hacking abilities were reduced by 1. However, you got a new device which might help you to shut power down, you have the second chance to continue the mission. Type [1] to roll")
    def full_fail(self):
        print("You lost! You did not manage to hack electricity and time is out.") 
    def full_success(self):
        print("Well done! You hacked electricity and improved your hacking abilities by 1 so that now terrorists don't have light.")
